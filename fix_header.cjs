...
const fullHeader = `import React, { useState, useRef, useEffect } from "react";
import {
  Menu,
  Moon,
  Sun,
...
const MONTH_DETAILS = [
  { id: "01", enShort: "Jan", bnShort: "জানু", bnFull: "জানুয়ারি" },
  { id: "02", enShort: "Feb", bnShort: "ফেব", bnFull: "ফেব্রুয়ারি" },
  { id: "03", enShort: "Mar", bnShort: "মার্চ", bnFull: "মার্চ" },
  { id: "04", enShort: "Apr", bnShort: "এপ্রিল", bnFull: "এপ্রিল" },
  { id: "05", enShort: "May", bnShort: "মে", bnFull: "মে" },
  { id: "06", enShort: "Jun", bnShort: "জুন", bnFull: "জুন" },
  { id: "07", enShort: "Jul", bnShort: "জুল", bnFull: "জুলাই" },
  { id: "08", enShort: "Aug", bnShort: "আগ", bnFull: "আগস্ট" },
  { id: "09", enShort: "Sep", bnShort: "সেপ্টে", bnFull: "সেপ্টেম্বর" },
  { id: "10", enShort: "Oct", bnShort: "অক্টো", bnFull: "অক্টোবর" },
  { id: "11", enShort: "Nov", bnShort: "নভে", bnFull: "নভেম্বর" },
  { id: "12", enShort: "Dec", bnShort: "ডিসে", bnFull: "ডিসেম্বর" },
];
...
fs.writeFileSync('src/components/Header.tsx', fullHeader);
