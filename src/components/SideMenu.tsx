      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] overflow-hidden select-none">
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-purple-950/30 shrink-0">
              ...
              <button
                onClick={onClose}
                className="p-1.5 rounded-lg bg-slate-50 dark:bg-zinc-900 border border-zinc-850 text-slate-700 dark:text-zinc-400 hover:text-slate-900 dark:hover:text-white transition-all cursor-pointer"
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-slate-700 dark:text-zinc-400 block mt-0.5">
                      {t("sideMenu.finalLedgerDesc")}
                    </span>
                  </div>
                </div>
                <div className="text-[11px] font-semibold text-slate-600 dark:text-zinc-500 bg-slate-50 dark:bg-zinc-900 border border-zinc-850 px-2 py-0.5 rounded">
              ...
              >
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-slate-700 dark:text-zinc-400 block mt-0.5">{t("sideMenuFixed.dutyScheduleDesc")}</span>
                  </div>
                </div>
            ...
            <div className="space-y-2 border-t border-zinc-900/40 pt-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 rounded-xl bg-slate-100 dark:bg-zinc-950 border border-slate-300 dark:border-zinc-900 text-[10px] font-sans font-semibold text-slate-600 dark:text-zinc-500 hover:text-red-400 transition-colors cursor-pointer"
              >
                  ...
                  <div className="space-y-4 flex-1 flex flex-col min-h-0">
                    ...
                    <div className="grid grid-cols-3 gap-2 px-0.5 shrink-0">
                      <div className="bg-slate-50 dark:bg-zinc-900/40 border border-slate-200 dark:border-purple-950/10 p-2.5 rounded-xl flex flex-col justify-between items-center text-center shadow-sm">
                        <span className="text-[9px] text-slate-700 dark:text-zinc-400 block font-semibold leading-none">
                    ...
                    <div className="flex items-center justify-between bg-slate-50 dark:bg-zinc-900/20 border border-slate-200 dark:border-purple-950/5 px-3.5 py-2.5 rounded-xl shrink-0">
                      <div className="text-left">
                        ...
                        <span className="text-[9px] text-slate-700 dark:text-zinc-400 block mt-0.5">
                    ...
                    <div className="flex-1 overflow-y-auto space-y-3 pr-1 py-1">
                      {members.length === 0 ? (
                        <div className="text-center py-10 text-xs text-slate-600 dark:text-zinc-500">
                            ...
                            >
                              ...
                              <div className="grid grid-cols-5 gap-2 text-center border-t border-slate-200 dark:border-purple-950/5 pt-3">
                                <div className="flex flex-col">
                                  <span className="text-[10px] text-slate-700 dark:text-zinc-400 font-medium">
                                ...
                                <div className="flex flex-col">
                                  <span className="text-[10px] text-slate-700 dark:text-zinc-400 font-medium font-sans">
                                ...
                                <div className="flex flex-col">
                                  <span className="text-[10px] text-slate-700 dark:text-zinc-400 font-medium font-sans font-sans">
                    ...
                    <div className="bg-amber-950/15 border border-amber-900/30 rounded-xl p-3 flex gap-2 shrink-0">
                      ...
                      <p className="text-[10px] text-slate-700 dark:text-zinc-400 leading-normal">
            ...
            {activeModal === "duty" && (
              <div className="space-y-4 flex-1">
                ...
                <form
                  ...
                  className="bg-white dark:bg-[#120e20] p-4 border border-slate-200 dark:border-purple-950/25 rounded-2xl space-y-4 shadow-xl"
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 relative">
                    ...
                    <div className="relative">
                      <label className="block text-[10px] text-slate-700 dark:text-zinc-400 mb-1 font-semibold">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between text-[11px] font-bold py-2.5 px-3 rounded-xl bg-slate-50 dark:bg-zinc-900/80 hover:bg-slate-100 dark:hover:bg-zinc-850/90 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 transition-all text-left cursor-pointer shadow-sm active:scale-95"
                      >
                        <span className="truncate">{selectedDay}</span>
                        <ChevronDown
                          className={`w-3.5 h-3.5 transition-transform duration-200 text-slate-600 dark:text-zinc-500 ${isDaySelectOpen ? "rotate-180 text-brand-accent" : ""}`}
                        />
                      </button>

                      {isDaySelectOpen && (
                        <div className="absolute z-40 mt-1.5 w-full bg-white dark:bg-[#18142c] border border-slate-200 dark:border-purple-950/40 rounded-xl shadow-2xl py-1 max-h-48 overflow-y-auto divide-y divide-purple-950/10">
                          {weekdays.map((day) => (
                            <button
                              key={day}
                              type="button"
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`w-3.5 h-3.5 transition-transform duration-200 text-slate-600 dark:text-zinc-500 ${isMemberSelectOpen ? "rotate-180 text-brand-accent" : ""}`}
                        />
                      </button>
                      ...
                      {isMemberSelectOpen && (
                        <div className="absolute z-40 mt-1.5 w-full bg-white dark:bg-[#18142c] border border-slate-200 dark:border-purple-950/40 rounded-xl shadow-2xl py-1 max-h-48 overflow-y-auto divide-y divide-purple-950/10">
                          {members.length === 0 ? (
                            <div className="px-3 py-2 text-[10px] text-slate-600 dark:text-zinc-500">
                  ...
                  <div className="space-y-1.5">
                    <label className="block text-[10px] text-slate-700 dark:text-zinc-400 font-semibold">
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      <button
                        ...
                        className={`flex items-center gap-2 p-2.5 rounded-xl border transition-all text-left cursor-pointer focus:outline-none ${
                          ...
                          selectedRole !== t("sideMenuFixed.roleCooking")
                            ...
                            : "bg-slate-50 dark:bg-zinc-900/40 border-slate-300 dark:border-zinc-900 text-slate-700 dark:text-zinc-400 hover:bg-slate-50 dark:hover:bg-zinc-900/70"
                        }`}
                      >
                        <div
                          className={`p-1.5 rounded-lg shrink-0 ${selectedRole === t("sideMenuFixed.roleBazaar") || selectedRole !== t("sideMenuFixed.roleCooking") ? "bg-brand-accent/25 text-brand-accent" : "bg-slate-100 dark:bg-zinc-850 text-slate-600 dark:text-zinc-500"}`}
                        >
                        ...
                        <div>
                          ...
                          <span className="text-[8px] text-slate-700 dark:text-zinc-400 block mt-0.5 whitespace-nowrap">
                      ...
                      >
                        <div
                          className={`p-1.5 rounded-lg shrink-0 ${selectedRole === t("sideMenuFixed.roleCooking") ? "bg-brand-amber/25 text-brand-amber" : "bg-slate-100 dark:bg-zinc-850 text-slate-600 dark:text-zinc-500"}`}
                        >
                ...
                <div className="space-y-2 max-h-[35vh] overflow-y-auto">
                  <span className="text-xs font-semibold text-slate-400 dark:text-zinc-400 block">
                          ...
                          >
                            <div className="flex justify-between items-start">
                              ...
                              <button
                                ...
                                className="text-slate-600 dark:text-zinc-500 hover:text-rose-450 p-1 rounded-md hover:bg-rose-950/15 transition-all text-[11px] cursor-pointer"
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
                ...
                <div className="bg-orange-950/20 border border-orange-900/30 rounded-xl p-4 text-center">
                  ...
                  <div className="space-y-3 text-left">
                    <label className="block text-xs font-bold text-slate-700 dark:text-zinc-400">{t("sideMenu.passwordPrompt")}</label>
                    <input
                      type="password"
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                ...
                {(!archives || archives.length === 0) ? (
                  <div className="text-center py-10 bg-slate-50 dark:bg-zinc-900/30 rounded-xl border border-slate-200 dark:border-zinc-800">
                    <p className="text-slate-600 dark:text-zinc-500 text-sm">{t("sideMenuFixed.noOldSessions")}</p>
                  </div>
                ) : (
                       ...
                       return (
                         <div key={arc.id || index} className="bg-slate-50 dark:bg-zinc-900 border border-blue-900/30 rounded-xl p-4 flex flex-col gap-3">
                           <div>
                             ...
                             <p className="text-xs text-slate-600 dark:text-zinc-500 mt-0.5">{t("sideMenuFixed.downloadCosts")}</p>
                           </div>
                           <button
                  ...
                  <div className="mt-6 pt-6 border-t border-emerald-900/30 text-left">
                    ...
                    <div className="flex gap-2 mb-3">
                      <div className="flex-1">
                        <label className="block text-[10px] text-slate-700 dark:text-zinc-400 mb-1">{t("sideMenuFixed.startLabel")}</label>
                        <input
                          type="date"
                      ...
                      <div className="flex-1">
                        <label className="block text-[10px] text-slate-700 dark:text-zinc-400 mb-1">{t("sideMenuFixed.endLabel")}</label>
                        <input
                          type="date"
                          value={exportEndDate}
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-slate-100 dark:bg-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-700 disabled:opacity-50 text-slate-900 dark:text-white rounded-xl text-xs font-bold transition-all cursor-pointer border border-slate-300 dark:border-zinc-700"
                    >
        ...
        {showResetConfirm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-200 dark:bg-black/85 backdrop-blur-md transition-all">
            <div className="bg-white dark:bg-[#18122B] border border-red-500/25 max-w-sm w-full rounded-2xl p-6 shadow-2xl relative text-center text-slate-800 dark:text-zinc-200 select-none">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-slate-50 dark:bg-zinc-900 hover:bg-slate-100 dark:hover:bg-zinc-850 text-slate-700 dark:text-zinc-400 font-bold rounded-xl text-xs border border-slate-200 dark:border-zinc-800 cursor-pointer"
                >
