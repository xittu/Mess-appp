            ...
            <AnimatePresence>
              {isPickerOpen && (
                <motion.div
                  ...
                  className="absolute end-0 mt-2 w-[310px] bg-brand-card border border-purple-950/80 rounded-2xl p-3.5 shadow-[0_10px_35px_-5px_rgba(0,0,0,0.85),_0_0_15px_rgba(168,85,247,0.15)] z-50 overflow-hidden"
                >
