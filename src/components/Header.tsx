...
const MONTH_DETAILS = [
  ...
  { id: "February 2026", enShort: "FEB", bnFull: "ফেব্রুয়ারি", bnShort: "ফেব্রু" },
  ...
  { id: "September 2026", enShort: "SEP", bnFull: "সেপ্টেম্বর", bnShort: "সেপ্টে" },
...
export default function Header({
  ...
  const currentMonthDetail = MONTH_DETAILS.find((m) => m.id === currentMonth) || MONTH_DETAILS[0];
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={pickerRef}>
            ...
            >
              ...
              <ChevronDown className={`w-3 h-3 text-zinc-400 shrink-0 transition-transform duration-300 ${isPickerOpen ? "rotate-180 text-brand-accent" : ""}`} />
            </button>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-2.5 pt-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      <h4 className="text-xs font-bold font-sans text-brand-amber">সেশন মাস নির্বাচন করুন</h4>
                    </div>
                    ...
                    {MONTH_DETAILS.map((month) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`text-[8px] font-mono tracking-wider font-semibold uppercase mb-0.5 ${
                            isSelected ? "text-purple-200" : "text-brand-accent/50 group-hover:text-brand-accent"
                          }`}>
                            {month.enShort}
                          </span>

                          <span className={`text-xs font-bold font-sans ${
                            isSelected ? "text-white" : "text-zinc-250 group-hover:text-brand-amber transition-colors"
                          }`}>
                            {month.bnShort}
                          </span>
                  ...
                  <div className="mt-3 pt-2.5 border-t border-purple-950/20 text-center flex items-center justify-center gap-1 text-[9px] text-zinc-405">
                    ...
                    <span className="text-zinc-400">নতুন মাস সিলেক্ট করলে ঐ মাসের রিপোর্ট লোড হবে</span>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
