...
export default function Header({
  ...
  return (
    <header className="w-full select-none">
      {/* Top Navigation Bar */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-purple-950/40 bg-brand-card/95 backdrop-blur-md sticky top-0 z-40 transition-colors duration-300">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col">
            {isEditing ? (
              ...
              >
                <input
                  ...
                  className="bg-zinc-900 border border-zinc-700 text-brand-amber font-sans text-sm font-bold tracking-tight rounded px-2 py-0.5 focus:outline-none focus:ring-1 focus:ring-brand-accent w-32 sm:w-40"
                  autoFocus
                  maxLength={100}
                  required
                />
              ...
              <div className="flex items-center gap-1.5">
                ...
                <div className="relative" ref={pickerRef}>
                  <button
                    ...
                    className={\`flex items-center gap-1 px-2 py-0.5 sm:py-1 text-[11px] font-semibold rounded-full border bg-zinc-900 transition-all duration-300 select-none cursor-pointer hover:shadow-[0_0_12px_rgba(168,85,247,0.15)] \${
                      isPickerOpen
                  ...
                  <AnimatePresence>
                    {isPickerOpen && (
                      <motion.div
                        ...
                        className="absolute left-0 -ml-4 sm:ml-0 mt-2 w-[280px] sm:w-[310px] bg-brand-card border border-purple-950/80 rounded-2xl p-3.5 shadow-[0_10px_35px_-5px_rgba(0,0,0,0.85),_0_0_15px_rgba(168,85,247,0.15)] z-50 overflow-hidden"
                      >
                              ...
                              >
                                ...
                                <span
                                  className={\`text-[11px] font-bold font-sans tracking-wide \${
                                    isSelected
                                      ? "text-white"
                                      : "text-zinc-300 group-hover:text-brand-amber transition-colors"
                                  }\`}
                                >
                                  {month.enShort}
                                </span>
            ...
            <div className="flex flex-col gap-0.5 mt-0.5">
              <div className="flex items-center gap-1 text-[10px] sm:text-[11px] text-zinc-400 font-mono">
                <span>ID: {messId}</span>
                <button
                  onClick={handleCopy}
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          <div className="relative" ref={langRef}>
            <button
              ...
              className={\`flex items-center gap-1 px-2 py-1 text-[11px] font-semibold rounded-full border bg-zinc-900 transition-all duration-300 select-none cursor-pointer hover:shadow-[0_0_12px_rgba(168,85,247,0.15)] \${
                isLangOpen
                  ? "border-brand-accent text-brand-amber bg-zinc-850"
